...
export default function Coffees() {
  ...
  let coffeeList = React.createRef();
  ...
  function changeCoffee(coffee) {
    let coffeeListElement = coffeeList.current;
    ...
    if(coffeeListElement.style.display === "block"){
      coffeeListElement.style.display = "none";
    }
    document.body.style.overflow = "auto"; 
  }

  function openCoffeesList(){
    window.scrollTo(0,0);
    let coffeeListElement = coffeeList.current;
    coffeeListElement.style.display = "block";
  ...
  return (
    <section>
      ...
      <div className="coffee-content">
        ...
        <div className="coffee-list" ref={coffeeList}>
      ...
      <div className="coffee-float-button" onClick={openCoffeesList}>
        <FontAwesomeIcon icon={faCoffee} className="iconCoffee" />
      </div>
